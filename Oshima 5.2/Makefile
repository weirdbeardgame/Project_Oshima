...
UNREALROOTPATH = /home/musungo/UnrealEngine
GAMEPROJECTFILE =/mnt/data/coding/Unreal/Project_Oshima/Oshima 5.2/Oshima.uproject
...
TARGETS = \
	...
	UnrealServer \
	Oshima-Linux-Debug  \
	Oshima-Linux-DebugGame  \
	Oshima-Linux-Test  \
	Oshima-Linux-Shipping  \
	Oshima \
	OshimaEditor-Linux-Debug  \
	OshimaEditor-Linux-DebugGame  \
	OshimaEditor-Linux-Test  \
	OshimaEditor-Linux-Shipping  \
	OshimaEditor\
	configure
...
StandardSet: RequiredTools UnrealFrontend OshimaEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug OshimaEditor-Linux-Debug
...
Oshima-Linux-Debug:
	 $(PROJECTBUILD) Oshima Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Oshima-Linux-DebugGame:
	 $(PROJECTBUILD) Oshima Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Oshima-Linux-Test:
	 $(PROJECTBUILD) Oshima Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Oshima-Linux-Shipping:
	 $(PROJECTBUILD) Oshima Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Oshima:
	 $(PROJECTBUILD) Oshima Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

OshimaEditor-Linux-Debug:
	 $(PROJECTBUILD) OshimaEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

OshimaEditor-Linux-DebugGame:
	 $(PROJECTBUILD) OshimaEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

OshimaEditor-Linux-Test:
	 $(PROJECTBUILD) OshimaEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

OshimaEditor-Linux-Shipping:
	 $(PROJECTBUILD) OshimaEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

OshimaEditor:
	 $(PROJECTBUILD) OshimaEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
